...
#define STRING_CONFIG_H_AUTHOR "Ade based on Jyers" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Printa"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  20.51,  20.51 }
    #define DEFAULT_Ki_LIST {   1.46,   1.46 }
    #define DEFAULT_Kd_LIST {  71.91, 71.91  }
  #else
    #define DEFAULT_Kp  20.51
    #define DEFAULT_Ki   1.46
    #define DEFAULT_Kd  71.91
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 263.25
  #define DEFAULT_bedKi  50.91
  #define DEFAULT_bedKd 907.43
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.60, 80.40, 408.40, 141.10 }
 ...
 */
#define DEFAULT_ACCELERATION          250.00    // X, Y, Z and E acceleration for printing moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.90, -4.60, -0.48 }
